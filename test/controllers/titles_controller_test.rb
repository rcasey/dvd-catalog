...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { categories_fk: @title.categories_fk, title: @title.title, year_published: @title.year_published }
    end
  ...
  test "should update title" do
    patch :update, id: @title, title: { categories_fk: @title.categories_fk, title: @title.title, year_published: @title.year_published }
    assert_redirected_to title_path(assigns(:title))
  end
